...
public enum ModArmorMaterials implements ArmorMaterial {
    EVILMATTER("evilmatter", 26, new int[]{4, 9, 7, 4}, 25,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 4f, 0.2f, () -> Ingredient.of(ModItems.EVILMATTER.get()));
    ...
    public String getName() {
        return FromTheBog.MOD_ID + ":" + this.name;
    }
