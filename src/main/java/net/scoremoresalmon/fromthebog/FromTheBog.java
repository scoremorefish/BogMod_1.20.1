package net.scoremoresalmon.fromthebog;
...
@Mod(FromTheBog.MOD_ID)
public class FromTheBog
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "fromthebog";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public FromTheBog(FMLJavaModLoadingContext context)
    {
